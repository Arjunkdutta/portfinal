$(document).ready(function () {
    ...
    function populateIntro() {
        ...
        var introContent = $("<p id='intro-text'>My name is <span class='red-text'>Arjun</span>. <br>I'm a <span class='red-text'>student in college</span>. <br>Welcome to my portfolio site!</p>");
    ...
    function populateAbout() {
        ...
        var aboutContent = $("<p id='about-text'>I am 21 years old, I am from the bay area and have lived here my entire life.</p>")
    ...
    function populateContact() {
        ...
        var contactContent2 = $("<p class='contact-text' class='left-align' style='padding-bottom: 5%'>Email: <br><span class='red-text'><a href='mailto:arjunkdutta@gmail.com'>arjunkdutta@gmail.com</a></span></p>")
    ...
    function populatePortfolio() {
        ...
        var projcard1 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><span style='font-size:1.40em;' class='card-title white-text red'>critive</span></div><div class='card-content'><p class='card-textcontent'>An app made for you to ask questions and recive credible answers.</p></div><a style='font-size:1.40em;padding:10px;' class='red-text' href='https://rocky-atoll-86939.herokuapp.com' target='_blank'>View Project</a><p style='font-size:1.40em;margin-top: 15px; margin-bottom: 5px;'><a class='black-text' href='' target='_blank'></a></p></div></div>");
        var projcard2 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><span style='font-size:1.40em;' class='card-title white-text red'>Home Chef App</span></div><div class='card-content'><p class='card-textcontent'>A web application to help you become a chef at home</p></div><a style='font-size:1.40em;padding:10px;' class='red-text' href='https://arjunkdutta.github.io/ProjectOne/' target='_blank'>View Project</a><p style='font-size:1.40em;margin-top: 15px; margin-bottom: 5px;'><a class='black-text' href='' target='_blank'></a></p></div></div>");
        var projcard3 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'></a></div></div>");
        var projcard4 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'></a></p></div></div>");
        var projcard5 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'> </a></p></div></div>");
